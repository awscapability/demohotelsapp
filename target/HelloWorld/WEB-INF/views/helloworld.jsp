...
<div class="header">
	...
	<!--Slider-->
		...
		<h3>Booking Successfully Completed</h3><br>
		
		<h3 sty>First Name : &nbsp;&nbsp;&nbsp; <%= request.getParameter("Firstname") %></h3><br>
		<h3>Last Name : &nbsp;&nbsp;&nbsp; <%= request.getParameter("Lastname") %></h3><br>
		<h3>Email Id : &nbsp;&nbsp;&nbsp; <%= request.getParameter("Email") %></h3><br>		
		<h3>Check In Date : &nbsp;&nbsp;&nbsp; <%= request.getParameter("Text1") %></h3><br>
		<h3>Check Out Date : &nbsp;&nbsp;&nbsp; <%= request.getParameter("Text2") %></h3><br>
		
		
		</div>
			<!--  <form action="#" method="get" class="w3_form_post" commandname="Booknow">
