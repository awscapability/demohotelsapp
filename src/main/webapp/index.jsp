...
<html lang="en">
<head>
<title>Hotels and Restaurants| Home</title>
...
<link rel="stylesheet" href="<c:url value="/resources/css/bootstrap.css"/>"> <!-- Bootstrap-Core-CSS -->
<link rel="stylesheet" href="<c:url value="/resources/css/style.css"/>" type="text/css" media="all" /> <!-- Style-CSS --> 
<link rel="stylesheet" href="<c:url value="/resources/css/font-awesome.css"/>"> <!-- Font-Awesome-Icons-CSS -->
<!-- //css files -->

<!-- online-fonts -->
<link href="<c:url value="https://fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i,900,900i"/>"	 rel="stylesheet">
<link href="<c:url value="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300,300i,400,400i,500,500i,600,600i,700,700i"/>" rel="stylesheet">
<link href="<c:url value="https://fonts.googleapis.com/css?family=Yanone+Kaffeesatz:200,300,400,700"/>" rel="stylesheet">
<!-- //online-fonts -->

<!-- js -->
<script type="text/javascript" src="<c:url value="https://code.jquery.com/jquery-2.1.4.min.js"/>"></script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script> <!-- Necessary-JavaScript-File-For-Bootstrap --> 
<!-- //js -->
</head>
<body>
<!-- header -->
<div class="header">
	...
	<!--Slider-->
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<img src="resources/images/popup.jpg" alt=" " class="img-responsive"/>
		...
		<h3>Hotel Booking form</h3>
			...
			<form method="get" class="w3_form_post" action = "redirect">
				...
				<div class="agileits_w3layouts_main_grid w3ls_main_grid">
					...
					<h5>Check In & Time *</h5>
						...
						<div class="agileits_w3layouts_main_gridl">
							<input class="date" id="datepicker" name="Text1" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '08/13/2016';}" required="">
						</div>
				...
				<div class="agileits_w3layouts_main_grid w3ls_main_grid">
					...
					<h5>Check Out & Time *</h5>
						...
						<div class="agileits_w3layouts_main_gridl">
							<input class="date" id="datepicker1" name="Text2" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '08/13/2016';}" required="">
						</div>
						<div class="agileits_w3layouts_main_gridr">
							<input type="time" name="Time" required="">
						</div>
				...
				<div class="w3_main_grid">
					...
					<div class="w3_main_grid_right">
						<input type="submit" value="Book" onclick = "location.href='target/HelloWorld/WEB-INF/views/helloworld.jsp'">
					</div>
					<div class="clearfix"> </div>
				</div>
			</form>
	...
	<div class="services-agile-head">
		...
		<div class="w3-agile-grids">
			...
			<div class="col-md-6 w3-agile-services-right">
				<img src="resources/images/ab1.jpg" alt="services">
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
...
<!--footer-->
<div class="footer-w3">
	<p>&copy; 2018 Dream Hotel. All rights reserved</p>
</div>
<!--//footer-->
